...
<form method="post" action="?url=proses-edit-siswa&nisn=<?= $nisn; ?>">
    <div class="form-groub mb-2">
        <label>NISN</label>
        <input value="<?= $data['nisn'] ?>" readeonly type="number" name="nisn" class="form-control" required>
    </div>
    <div class="form-groub mb-2">
        <label>NIS</label>
    ...
    <div class="form-group mb-2">
        ...
        <input value="<?= $data['no_telp'] ?>" type="number" name="no_telp" class="form-control" required></input>
    </div>
    <div class="form-groub mb-2">
        <label>SPP</label>
